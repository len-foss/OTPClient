...
void init_tray_icon(AppData *app_data) {
    // TODO: fix icon path
    app_data->indicator = app_indicator_new("otpclient", "/usr/share/icons/hicolor/scalable/apps/com.github.paolostivanin.OTPClient.svg", APP_INDICATOR_CATEGORY_APPLICATION_STATUS);
